...
function Sheet({
  ...
  // eleva: overlay-state props stay on the overlay; everything else (`style`,
  // `data-*`, `dir`, …) belongs to the panel so callers like `Sidebar` can target
  // it. The registry spreads all rest props onto the full-screen overlay.
  return (
    <SheetOverlay
      isOpen={isOpen}
...
function SheetDescription({
  ...
  return (
    // eleva: RAC `Text slot="description"` wires `aria-describedby`; a bare div does not.
    <Text
      slot="description"
      elementType="div"
