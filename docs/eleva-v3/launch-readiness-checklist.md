...
- [ ] Required environment variables are documented and present (`BETTER_AUTH_*`, `ELEVA_KEK_V*`, `DAILY_*`). After Phase 3, leftover identity-provider credentials are revoked.
