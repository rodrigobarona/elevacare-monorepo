...
- `packages/billing` is large: Embedded Components wrappers, AccountSession minting, two webhook routes + one dispatcher, commission logic, subscription lifecycle for both expert and clinic tiers
