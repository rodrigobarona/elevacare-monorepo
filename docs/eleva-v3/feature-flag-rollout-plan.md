...
Dropped: the previous identity provider as flag provider (not validated for this role; removed, see ADR-017). Flag provider decision is ADR-008 (Vercel Flags SDK + Edge Config).
