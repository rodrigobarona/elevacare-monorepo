...
12. **Approval gates** are decisions people outside engineering must sign before a PR opens
    ...
    | D-09 | Historical MVP invoices: `legacy` / `legacy_missing`, no reissue (Aprovado com condições 2026-09-15; regularization still required) | accountant        | PR 07.1 production issuance (fiscal params still pending) |
