...
hashes are user-scoped secrets visible only to platform administrators
...
| `notifications`                  | owner-user-visible SELECT/UPDATE(`read_at`) + service-only INSERT/DELETE |
