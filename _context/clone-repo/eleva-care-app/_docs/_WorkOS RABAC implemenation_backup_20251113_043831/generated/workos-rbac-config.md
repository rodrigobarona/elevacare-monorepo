...
| `billing:manage_clinic_sub`   | Manage Clinic Subscription | Manage clinic subscription |
| `billing:view_clinic_billing` | View Clinic Billing        | View clinic billing        |
...
| Slug                     | Name                   | Description                 |
| ------------------------ | ---------------------- | --------------------------- |
| `clinic:view_dashboard`  | View Clinic Dashboard  | View clinic overview        |
| `clinic:view_patients`   | View Clinic Patients   | View shared clinic patients |
| `clinic:view_schedule`   | View Clinic Schedule   | View clinic schedule        |
| `clinic:manage_settings` | Manage Clinic Settings | Manage clinic settings      |
| `clinic:manage_branding` | Manage Clinic Branding | Manage clinic branding      |
| `clinic:view_analytics`  | View Clinic Analytics  | View clinic analytics       |
| `clinic:export_data`     | Export Clinic Data     | Export clinic data          |
...
| Slug                     | Name                   | Description            |
| ------------------------ | ---------------------- | ---------------------- |
| `schedule:manage_clinic` | Manage Clinic Schedule | Manage clinic schedule |
...
| **Clinic Member**    | 60       | expert_community | 56                | Expert who is a member of a clinic organization (not admin). Can manage their own practice + view shared clinic resources |
| **Clinic Admin**     | 90       | clinic_member    | 77                | Administrator of a clinic organization. Can manage team, patients, schedule, and clinic settings                          |
| **Platform Admin**   | 100      | -                | 132               | Platform-level administrator with full system access. For Eleva Care team only                                            |

## Role-Permission Matrix

| Permission                      | Patient | Expert Community | Expert Top | Clinic Member | Clinic Admin | Platform Admin |
| ------------------------------- | ------- | ---------------- | ---------- | ------------- | ------------ | -------------- |
...
clinic:view_dashboard | View Clinic Dashboard
