      ...
      case 'generic': {
        try {
          const { title, description, variant } = genericSchema.parse({
            ...
            variant: searchParams.get('variant') || 'primary',
            imageType,
          });
            ...
            (
              ...
              >
                ...
                >
                  ...
                  >
                    <ElevaCareLogo color="#006D77" width={120} height={24} />
                  </div>
                </div>
              </div>
            ),
...
// Also export as POST to handle different request methods
export { handler as POST };
// Export HEAD for metadata requests
